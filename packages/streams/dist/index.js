...
var ServerlessOfflineStreamsPlugin = /** @class */ (function () {
    ...
    ServerlessOfflineStreamsPlugin.prototype.end = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.all(this.activeHandlers.map(function (h) { return h.shutdown(); }))];
            });
        });
    };
    return ServerlessOfflineStreamsPlugin;
}());
exports["default"] = ServerlessOfflineStreamsPlugin;
var mergeOptions = function (serverless, cliOptions) {
    var _a = serverless.service.custom, custom = _a === void 0 ? {} : _a;
    var customOptions = custom[constants_1.SLS_CUSTOM_OPTION];
    var offlineOptions = custom[constants_1.SLS_OFFLINE_OPTION];
    var extraOptions = {
        region: serverless.service.provider.region
    };
    return __assign(__assign(__assign(__assign({}, offlineOptions), customOptions), extraOptions), cliOptions);
};
