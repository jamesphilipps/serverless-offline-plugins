...
exports.createAndActivateQueues = exports.createQueues = exports.getExistingQueues = exports.getQueueDetails = void 0;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.all(((existingQueues === null || existingQueues === void 0 ? void 0 : existingQueues.QueueUrls) || []).map(function (QueueUrl) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, exports.getQueueDetails)(sqsClient, QueueUrl)];
...
exports.getExistingQueues = getExistingQueues;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, exports.getQueueDetails)(sqsClient, createResult.QueueUrl)];
                        case 2:
                            details = _c.sent();
...
var createAndActivateQueues = function (config, sqsClient, definedQueues) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                queuesToActivate = definedQueues
                    .filter(function (queue) { return config.createQueuesFromResources || queue.source !== 'RESOURCES'; }) // Filter resource queues if flag set
                ;
                return [4 /*yield*/, (0, exports.getExistingQueues)(sqsClient)];
            case 1:
                existingQueues = _a.sent();
                existingQueueNames = new Set(existingQueues.map(function (queue) { return queue.name; }));
                queuesToCreate = config.createQueuesFromResources ?
                    queuesToActivate
            ...
            case 2:
                ...
                existingActiveQueues = existingQueues
                    ...
                    .map(function (queue) { return (__assign(__assign({}, queuesToActivateByName[queue.name]), queue // Queue ARN and URL
                )); });
