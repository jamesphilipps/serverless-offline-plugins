...
var DynamoDBStreamsController = /** @class */ (function () {
    function DynamoDBStreamsController(serverless, lambda, options) {
    ...
    DynamoDBStreamsController.prototype.start = function (functionEvents) {
        var _this = this;
    ...
    DynamoDBStreamsController.prototype.stop = function () {
    ...
    DynamoDBStreamsController.prototype.count = function () {
        return this.readableStreams.length;
    };
    DynamoDBStreamsController.prototype._describeTable = function (TableName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DynamoDBStreamsController.prototype._extractTableNameFromARN = function (arn) {
        var _a, _b, _c, _d;
    ...
    DynamoDBStreamsController.prototype._createStream = function (functionKey, LatestStreamArn, shardId, event) {
        var _this = this;
    ...
    return DynamoDBStreamsController;
}());
exports["default"] = DynamoDBStreamsController;
